		...
		<div className="relative">
			<div className="flex flex-row items-center gap-3">
				...
				<Link
					...
					className="hidden md:block text-sm font-semibold py-3 px-4 rounded-full border border-dashed  transition cursor-pointer text-light hover:text-darkNavy hover:border-darkNavy hover:border-solid"
				>
					Go to Bancor
				</Link>
				<div
